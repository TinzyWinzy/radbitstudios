...
export const metadata: Metadata = {
  ...
  description: 'Real-time compliance threat assessments for SADC enterprises. Generated by the Radbit Epistemic Trend Interceptor (RETI) from live policy data.',
...
export default async function ThreatsListPage() {
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-12 md:py-24 space-y-10">
      <div className="space-y-4">
        ...
        <p className="text-lg text-foreground/60 max-w-2xl leading-relaxed">
          Real-time compliance intelligence generated by the Radbit Epistemic Trend Interceptor (RETI). Each assessment
          monitors PRAZ, SADC, ZIMRA, and regional policy shifts — then maps the threat to a specific armor layer.
        </p>
      </div>
      ...
      {assessments.length === 0 ? (
        <div className="text-center py-16 space-y-4">
          ...
          <p className="text-muted-foreground/60">No threat assessments generated yet. The RETI agent is monitoring policy channels and will publish assessments as events are detected.</p>
        </div>
      ) : (
