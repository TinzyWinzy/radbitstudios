        ...
        <div className="container px-4 max-w-2xl mx-auto text-center space-y-6">
          ...
          <div className="grid gap-4 sm:grid-cols-2 text-left">
            {[
              ...
              { q: "What taxes apply?", a: "The applicable taxes depend on the entity, activity and current rules. Use Radbit resources as general information and confirm your position with ZIMRA or a qualified tax practitioner." },
