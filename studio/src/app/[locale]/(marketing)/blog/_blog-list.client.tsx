...
export function BlogList() {
  ...
  if (loading) {
    return (
      <div className="grid gap-4 md:gap-8 md:grid-cols-2 lg:grid-cols-3 content-visibility-auto">
        {[1, 2, 3].map((i) => (
          <div
            key={i}
            className="rounded-xl border border-border/50 bg-card/50 p-6 animate-pulse space-y-3"
          >
