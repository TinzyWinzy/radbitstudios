      ...
      <section className="py-8 border-t border-border">
        <div className="container text-center">
          <p className="text-xs text-muted-foreground/40">
            This assessment was generated by the Radbit Epistemic Trend Interceptor (RETI) — an autonomous Vertex AI agent monitoring {holon.metadata.trigger_source} and regional policy shifts in real time.
          </p>
        </div>
      </section>
    </div>
