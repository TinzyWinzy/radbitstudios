...
export const ThreatAssessmentInputSchema = z.object({
  ...
  triggerCategory: z.enum(['praz', 'sadc', 'ai_strategy', 'afcfta', 'zimra', 'rbz', 'nssa', 'general', 'data_protection', 'energy_grid', 'mining', 'digital_regulation', 'afcfta_customs', 'sadc_industry']),
