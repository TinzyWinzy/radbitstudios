...
export const industries: IndustryPage[] = [
  {
    ...
    metaDescription: 'POS, inventory, WhatsApp ordering, and sales tools for Zimbabwean retailers and e-commerce businesses.',
    h1: 'Retail & E-commerce Tools for Zimbabwean Businesses',
    intro: 'Running a retail shop or online store in Zimbabwe means dealing with currency swings, unreliable power, and customers who expect WhatsApp ordering. Radbit helps you keep stock, sales, and delivery records in one place.',
    problems: [
      ...
      { title: 'Currency confusion', description: 'Multi-currency pricing creates headaches at checkout and in accounting.' },
    ...
    solutions: [
      ...
      { title: 'Multi-Currency POS', description: 'Record USD, ZiG, mobile money, and card payments clearly for sales and accounting.' },
  ...
  },
  {
    ...
    intro: 'Whether you run an accounting firm, law practice, or consulting agency in Zimbabwe, admin can crowd out billable work. Radbit helps you manage invoices, client records, documents, and compliance reminders.',
    problems: [
  ...
  },
  {
    ...
    cta: 'Track tenders and documents',
  ...
  },
  {
    ...
    metaDescription: 'Patient management, appointment scheduling, stock, and billing tools for Zimbabwean clinics, pharmacies, and healthcare providers.',
    ...
    solutions: [
      ...
      { title: 'SMS/WhatsApp Reminders', description: 'Send appointment reminders and keep a record of patient communication.' },
  ...
  },
  {
    ...
    intro: 'Zimbabwean schools juggle fee collection, exam records, parent communication, and reporting, often on paper. Radbit helps schools keep admin records easier to find and update.',
    problems: [
    ...
    solutions: [
      ...
      { title: 'Digital Gradebook', description: 'Enter marks, calculate averages, generate report cards, and create transcripts in one place.' },
  ...
  },
  {
    ...
    intro: 'Zimbabwe\'s financial services sector, from microfinance to SACCOs, needs clean records for loans, compliance, and client relationships. Radbit helps teams move beyond fragile spreadsheets.',
    problems: [
    ...
    cta: 'Organize lending operations',
...
export const useCases: UseCasePage[] = [
  {
    ...
    h1: 'Tender Matching for Zimbabwean Businesses',
    intro: 'Tender opportunities are easy to miss when they are spread across portals, newspapers, and private procurement pages. Radbit helps you track relevant opportunities and the documents needed to respond.',
    steps: [
      { title: 'Create your business profile', description: 'Tell us your industry, CIDB grade, location, and capacity. Takes 5 minutes.' },
      { title: 'Track procurement sources', description: 'Radbit tracks public and private tender sources and flags opportunities that match your business profile.' },
    ...
    benefits: ['Spend less time searching for tenders', 'Keep closing dates visible', 'Draft proposals with AI assistance', 'Track PRAZ and document requirements'],
    cta: 'Start tracking tenders',
  ...
  },
  {
    ...
    metaDescription: 'Assess your business operations and get a practical roadmap for improving records, tools, workflows, and compliance readiness.',
    h1: 'How Ready Is Your Business to Scale?',
    ...
    steps: [
      { title: 'Answer practical questions', description: 'Cover operations, marketing, finance, compliance, and technology. No jargon, just plain business questions.' },
  ...
  },
  {
    ...
    benefits: ['Keep PRAZ renewal dates visible', 'Reduce document chasing', 'Prepare compliance packs faster', 'Track multiple registrations in one place'],
    cta: 'Track compliance records',
  ...
  },
  {
    ...
    metaDescription: 'Business plan, bid writing, tax, and document tools built around Zimbabwean workflows and practical SME needs.',
    h1: 'AI Tools Built for Zimbabwean Business Realities',
    intro: 'Generic AI tools often miss local context. Radbit keeps the workflow grounded in Zimbabwean business records, tender documents, tax notices, and payment habits.',
    steps: [
