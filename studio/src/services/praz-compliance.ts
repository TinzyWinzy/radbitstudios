...
export const REQUIRED_DOCUMENTS = [
  { id: 'cert_incorporation', label: 'Certificate of Incorporation', description: 'Company registration document from the Registrar of Companies' },
  { id: 'cr14', label: 'CR14 — List of Shareholders', description: 'Current list of shareholders filed with the Registrar' },
  { id: 'cr6', label: 'CR6 — List of Directors', description: 'Current list of directors filed with the Registrar' },
